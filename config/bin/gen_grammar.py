		...
		for i in range(len(separated)):
			if i==len(separated)-2:
				if len(separated)==2:
					...
					if newlist.count(str(separated[i])+"-"+str(separated[i+1]))==0:
						newlist.append(str(separated[i])+"-"+str(separated[i+1]))
#			elif i==len(separated)-2:
#				if newlist.count(separated[i])==0:
#                                	newlist.append(separated[i])
			#	if newlist.count(str(separated[i])+"+"+str(separated[i+1]))==0:
			#		newlist.append(str(separated[i])+"+"+str(separated[i+1]))
			if i<len(separated)-2:
			#	if newlist.count(separated[i])==0:
			...
			#	if newlist.count(str(separated[i])+"+"+str(separated[i+1]))==0:
                        #        	newlist.append(str(separated[i])+"+"+str(separated[i+1]))
			#	if newlist.count(str(separated[i+1])+"-"+str(separated[i+2]))==0:
                        #                newlist.append(str(separated[i+1])+"+"+str(separated[i+2]))
